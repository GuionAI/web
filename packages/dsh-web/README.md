...
DeepSeek Harness 0.1.2-alpha.5 Web bundle and browser settings client for Guion Web.
...
artifacts, profile patch, and exact DSH `0.1.2-alpha.5` peer contract are included
